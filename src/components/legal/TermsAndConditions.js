  ...
  return (
    <div id="terms-and-conditions">
      ...
      <p>
        ...
        conditions. Do not continue to use Aspyere if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Aspyere, you agreed to use
        cookies in agreement with the Aspyere's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Aspyere and/or its licensors own the
        intellectual property rights for all material on Aspyere. All
        intellectual property rights are reserved. You may access this from
        Aspyere for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Aspyere</li>
        <li>Sell, rent or sub-license material from Aspyere</li>
        <li>Reproduce, duplicate or copy material from Aspyere</li>
      ...
      <p>
        ...
        Aspyere does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Aspyere,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Aspyere shall not be liable for the
      ...
      <p>
        Aspyere reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Aspyere a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Aspyere; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Aspyere. Please include your name, your organization name,
      ...
      <p>
        No use of Aspyere's logo or other artwork will be allowed for linking
