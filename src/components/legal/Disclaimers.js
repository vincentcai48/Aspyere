export default function Disclaimers() {
  return (
    <div id="disclaimers">
      <h1>Disclaimers for Aspyere</h1>

      <p>
        If you require any more information or have any questions about our
        site's disclaimer, please feel free to contact us by email at
        contact@aspyere.com. Our Disclaimer was generated with the help of the{" "}
      </p>

      <h2>Disclaimers for Aspyere</h2>

      <p>
        All the information on this website - https://aspyere.com/ - is
        published in good faith and for general information purpose only.
        Aspyere does not make any warranties about the completeness, reliability
        and accuracy of this information. Any action you take upon the
        information you find on this website (Aspyere), is strictly at your own
        risk. Aspyere will not be liable for any losses and/or damages in
