  ...
  return (
    <div id="privacy-policy">
      ...
      <p>
        ...
        contains types of information that is collected and recorded by Aspyere
        and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Aspyere. This policy is not applicable to any
      ...
      <p>
        Aspyere follows a standard procedure of using log files. These files log
      ...
      <p>
        Aspyere uses cookies. These cookies are used to store information
      ...
      <p>
        ...
        advertising partners of Aspyere.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Aspyere, which are sent directly
      ...
      <p>
        Note that Aspyere has no access to or control over these cookies that
      ...
      <p>
        Aspyere's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Aspyere does not knowingly collect any Personal Identifiable Information
